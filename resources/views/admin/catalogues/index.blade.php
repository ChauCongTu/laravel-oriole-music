...
@section('content')
    <section class="bg-white p-3">
        <div class="row">
            <div class="col-md-12">
                <!-- DATA TABLE -->
                <h3 class="title-3 m-b-35">Quản lý danh mục sản phẩm</h3>
                <div class="table-data__tool">
                    <div class="table-data__tool-left">
                        <form action="{{ route('quan-ly-loai-san-pham.index') }}" method="get" class="d-flex">
                    ...
                    <div class="table-data__tool-right">
                        <a href="{{ route('quan-ly-loai-san-pham.create') }}"
                                ...
                                <tr class="border-top">
                                    ...
                                    <td>
                                        <div class="table-data-feature">
                                            <a href="{{ route('quan-ly-loai-san-pham.edit', ['quan_ly_loai_san_pham' => $value]) }}"
                                ...
                                <div class="modal fade" id="del_{{ $value->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form
                                                action="{{ route('quan-ly-loai-san-pham.destroy', ['quan_ly_loai_san_pham' => $value]) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
