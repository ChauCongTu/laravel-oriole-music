...
@section('content')
    <section class="bg-white p-3">
        <div class="row">
            <div class="col-md-12">
                <!-- DATA TABLE -->
                <h3 class="title-3 m-b-35">Quản lý danh mục</h3>
                    ...
                    <table class="table table-data2">
                        ...
                        <tbody>
                            ...
                            @foreach ($categories as $category)
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="del_{{ $category->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('quan-ly-danh-muc.destroy', ['quan_ly_danh_muc' => $category]) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
