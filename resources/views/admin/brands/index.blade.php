...
@section('content')
    <section class="bg-white p-3">
        <div class="row">
            <div class="col-md-12">
                <!-- DATA TABLE -->
                <h3 class="title-3 m-b-35">Quản lý thương hiệu</h3>
                <div class="table-data__tool">
                    <div class="table-data__tool-left">
                        <form action="{{ route('quan-ly-thuong-hieu.index') }}" method="get" class="d-flex">
                                ...
                                <tr class="border-top">
                                    ...
                                    <td>
                                        <div class="table-data-feature">
                                            <a href="{{ route('quan-ly-thuong-hieu.edit', ['quan_ly_thuong_hieu' => $value]) }}"
                                ...
                                <div class="modal fade" id="del_{{ $value->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form
                                                action="{{ route('quan-ly-thuong-hieu.destroy', ['quan_ly_thuong_hieu' => $value]) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
